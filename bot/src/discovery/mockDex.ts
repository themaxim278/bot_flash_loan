...
const WETH: Token = { symbol: 'WETH', address: '0xWETH', decimals: 18 };
const DAI: Token = { symbol: 'DAI', address: '0xDAI', decimals: 18 };
const USDC: Token = { symbol: 'USDC', address: '0xUSDC', decimals: 6 };

export function fetchMockPools(): Pool[] {
  return [
